...
export default function NewsDetailPage() {
  ...
  const article = {
    ...
    tags: ["Annual Report", "Growth", "Achievements"],
    content: [
      "Support Plus has published its 2024 annual report with a focus on delivery execution, client retention, and operational maturity.",
      "The report highlights expanded service coverage and stronger coordination between product, implementation, and support teams.",
      "It also summarizes improvements in project governance, onboarding workflows, and post-launch follow-up standards.",
      "Team development remained a priority through targeted hiring and practical enablement programs for delivery roles.",
      "Across the year, the company introduced new service tracks and completed a wide range of client projects across sectors.",
      "The 2025 roadmap continues this direction with emphasis on quality of delivery, regional presence, and long-term client outcomes."
    ]
  }
