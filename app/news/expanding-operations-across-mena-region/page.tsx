...
export default function NewsDetailPage() {
  ...
  const article = {
    ...
    tags: ["Expansion", "MENA", "Growth"],
    content: [
      "Support Plus is expanding its operating footprint across MENA to reduce response times and improve local delivery coordination.",
      "The expansion plan includes additional service coverage, new hiring across delivery functions, and stronger in-region support workflows.",
      "Client-facing teams will keep the same service channels while regional squads handle onboarding and implementation more directly.",
      "Operational updates also include clearer escalation paths between product, support, and account teams.",
      "Alongside the expansion, Support Plus is increasing practical training initiatives for local specialists involved in client projects.",
      "The objective for this phase is straightforward: more reliable execution close to client operations."
    ]
  }
