...
export default function NewsDetailPage() {
  ...
  const article = {
    ...
    category: "Product",
    author: "Product Team",
    tags: ["AI Modules", "Product Update", "Features"],
    content: [
      "This release adds a focused set of improvements across analytics, language workflows, and configuration controls in AI Modules.",
      "Teams can now manage forecasting views with clearer assumptions and better separation between raw signals and business rules.",
      "Language workflows were updated to improve routing for bilingual content, especially in support and document-heavy processes.",
      "Computer vision pipelines now include cleaner validation checkpoints, making QA review easier before production deployment.",
      "Decision automation has been refined with better rule tracing so operations teams can audit why a specific action was triggered.",
      "The update is available through the current platform interface, with migration notes included for active client environments."
    ]
  }
