...
export default function NewsDetailPage() {
  ...
  const article = {
    ...
    tags: ["Success Stories", "Clients", "Case Studies"],
    content: [
      "The 2024 recap highlights projects where clients focused on operational clarity rather than one-time quick wins.",
      "In financial services, teams used workflow automation to reduce manual handoffs and shorten review cycles in day-to-day processing.",
      "Retail clients prioritized campaign execution and reporting discipline, which helped teams react faster to seasonal demand changes.",
      "Healthcare implementations centered on service continuity, with stronger coordination between front-desk, support, and back-office teams.",
      "Manufacturing projects focused on maintenance planning and inventory visibility to reduce avoidable disruptions.",
      "Across these engagements, the common factor was steady adoption, clear ownership, and iterative delivery with client teams."
    ]
  }
